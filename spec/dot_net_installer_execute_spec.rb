...
describe BradyW::DotNetInstallerExecute do
  ...
  it 'should work properly in install mode with no properties' do
    ...
    # assert
    expect(@commands.first).to eq('elevate -w "stuff\\some.exe" /i /q /Log /LogFile generated_name_1.xml')
  end
  ...
  it 'should work properly in install mode with a single property' do
    ...
    # assert
    expect(@commands.first).to eq('elevate -w "some.exe" /i /ComponentArgs *:"SOMETHING=stuff" /q /Log /LogFile generated_name_1.xml')
  end
  ...
  it 'should work properly in install mode with multiple properties with whitespace and quotes' do
    ...
    # assert
    expect(@commands.first).to eq('elevate -w "some.exe" /i /ComponentArgs *:"SOMETHING=stuff SPACES=""hi there"" QUOTES=""hello """"there"""" joe""" /q /Log /LogFile generated_name_1.xml')
  end
  ...
  it 'should work properly with uninstall' do
    ...
    # assert
    expect(@commands.first).to eq('elevate -w "some.exe" /x /q /Log /LogFile generated_name_1.xml')
  end
